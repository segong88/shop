...
//        }
    ...
    public String register(@Valid ItemDTO itemDTO, BindingResult bindingResult,
    ...
    @GetMapping("/update")
    public String update(Long id, Model model, Principal principal,
                       RedirectAttributes redirectAttributes) {
    ...
    public String updatePost(ItemDTO itemDTO, MultipartFile[] multipartFile, MultipartFile mainimg, Long[] delino) {
        ...
        try{
            ...
            //RedirectAttributes 추가할 예정 msg 이미지 수정 실패
